...
class TTSManager {
    constructor() {
        // ── Defaults ────────────────────────────────────────────────────
        this.model    = 'sarvam';   // active TTS model (Sarvam AI Bulbul v3)
        this.voice    = 'ritu';     // active voice/speaker
    ...
    _setButtonState(state) {
        // No-op to delegate all visual state updates to PlaybackController.
    }
